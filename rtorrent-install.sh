...
if [ "$INSTALLRUTORRENT1" = "YES" ]; then echo " Install/Update RUTORRENT: $INSTALLRUTORRENT1 and PLUGINS: $INSTALLPLUGINS1"; echo; else echo "Install/Update RUTORRENT: $INSTALLRUTORRENT1"; echo; fi
